return {
	...
	opts = {
		...
		keymaps = {
			...
			["<CR>"] = { "actions.select", mode = "n", desc = "Select" },
			["<C-s>"] = { "actions.select", opts = { vertical = true } },
			["<C-h>"] = { "actions.select", opts = { horizontal = true } },
			["<C-t>"] = { "actions.select", opts = { tab = true } },
			["<C-p>"] = { "actions.preview", mode = "n", desc = "Preview" },
			["<C-c>"] = { "actions.close", mode = "n", desc = "Close" },
			["<C-l>"] = { "actions.refresh", mode = "n", desc = "Refresh" },
			["-"] = { "actions.parent", mode = "n", desc = "Parent" },
			["_"] = { "actions.open_cwd", mode = "n", desc = "Open current working directory" },
			["`"] = { "actions.cd", mode = "n" },
			["g~"] = { "actions.cd", opts = { scope = "tab" }, mode = "n", desc = "Change directory to tab" },
